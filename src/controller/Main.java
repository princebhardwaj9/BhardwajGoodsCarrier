...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		int choice;
		boolean adminbool,customerbool,boolmain;
				...
				case 1:
					...
					if(login.getLogin("admin", adminemail, adminpassword)) {
						...
						do {
							...
							System.out.println("6: Check All Truck Status");
							System.out.println("7: Delete Truck");
							System.out.println("8: TO EXiT/LOGOUT");
							choice=Integer.parseInt(br.readLine());
							System.out.println();
							if(choice==1) {
								...
								String trucklocation=br.readLine();
								adminDAO.updateLocation(trucknum, trucklocation);
								adminbool=true;
							}
							else if(choice==6) {
								adminDAO.getTruckStatusWithType();
